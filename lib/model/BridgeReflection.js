const AssignmentValidation = require('./AssignmentValidation')
const Reflection = require('./Reflection')
class BridgeRelation extends AssignmentValidation {
	...
	static distinct () { return this.newReflection.distinct(...arguments) }
	static uniq () { return this.newReflection.distinct(...arguments) }
	...
	// destroy
  static destroy (options) { return this.newReflection.destroy(...arguments) }
	static destroyAll() { return this.newReflection.destroyAll(...arguments) }
	static destroyAllTableData() { return this.newReflection.destroyAllTableData(...arguments) }
	
	// joins
	static joins(options, ...args) { return this.newReflection.joins(...arguments) }
